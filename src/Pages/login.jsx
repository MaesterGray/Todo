    ...
    <div className=' w-screen h-screen bg-white flex flex-col  items-center '>
        ...
        <div className='flex flex-col space-y-5 items-center h-[53vh] shadow-black shadow-lg rounded-md py-5 sm:space-y-1 sm:h-[60vh] md:h-[50vh] md:justify-center md:space-y-8 lg:h-[60vh]'>
                ...
                <form className='flex flex-col space-y-4 w-[60vw] sm:space-y-3 md:space-y-5 lg:space-y-2' >
                    ...
                    <Link to={'/Forgot'} className=' underline decoration-solid text-right '>Forgot password?</Link>
                    ...
                    <span className='md:text-2xl'>Don't have an account? <Link to={'SignUp'} className='text-red-500 '>Create One</Link></span>
